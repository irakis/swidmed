export const data = {
    ...
    items: ['doświadczają braku ochoty na seks', 'mają problemy z utrzymaniem erekcji, kontrolą wytrysku bądź lubrykacją miejsc intymnych', 'odczuwają brak satysfakcji z pożycia', 'nadużywają pornografii', 'nie akceptują własnej płci czy orientacji', 'doświadczyły nadużycia seksualnego']
}